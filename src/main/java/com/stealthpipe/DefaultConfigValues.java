...
public class DefaultConfigValues {
    ...
    public static final String RELAY_IP = "https://publicuser22222222-mcpipeservice-go.hf.space";
    public static final String RELAY_IP_WS = "wss://publicuser22222222-mcpipeservice-go.hf.space";
